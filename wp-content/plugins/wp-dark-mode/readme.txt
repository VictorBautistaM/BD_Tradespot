...
Tags: dark, dark mode, night mode, dark mode plugin, gutenberg blocks, dark theme
...
Works across all operating systems including Android, iOS, macOS. No settings are needed. This dark mode plugin intelligently detects device preferences and dynamically delivers a handcrafted, expert-designed dark mode experience for your readers.
...
1. **Themes Compatible** – The plugin is compatible with most popular WordPress themes without any issues. Compatiability includes: Avada, Betheme, The7, Flatsome, Astra, BuddyBoss, Divi, OceanWP and many more. [Check the full list of compatible themes](https://wppool.dev/dark-mode-compatibility/).
1. **Popular Page builder Compatibility** - This plugin is compatible Divi Builder, WP Bakery, Visual Composer, Beaver Builder, Oxygen Builder and Elementor.
1. **Revolution Slider Compatible** - This plugin is compatible with revolution slider.
