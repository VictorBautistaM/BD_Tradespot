...
if (!class_exists('WP_Dark_Mode_Admin')) {
	...
	class WP_Dark_Mode_Admin
	{
		...
		public function __construct()
		{
			...
			add_action('admin_bar_menu', [$this, 'render_admin_switcher_menu'], 99);
...
<?php }
		...
		public function admin_menu()
		{
			...
			add_submenu_page('wp-dark-mode-settings', __('Get Started - WP Dark Mode', 'wp-dark-mode'), __('Get Started', 'wp-dark-mode'), 'manage_options', 'wp-dark-mode-get-started', [ $this, 'getting_started' ]);


			// Register tools submenu page
			add_submenu_page('wp-dark-mode-settings', __('WP Dark Mode Tools - WP Dark Mode', 'wp-dark-mode'), __('Tools', 'wp-dark-mode'), 'manage_options', 'wp-dark-mode-tools', [ $this, 'admin_tools' ], 20);


			$this->recommended_plugins_menu();

			if (!wp_dark_mode()->is_pro_active() && !wp_dark_mode()->is_ultimate_active()) {
				add_submenu_page('wp-dark-mode-settings', __('Get PRO - WP Dark Mode', 'wp-dark-mode'), '<span id="get-wp-dark-mode-pro-menu">Get WP Dark Mode <span>PRO</span></span>', 'manage_options', '#', 99999999);
			}
		}
		/**
