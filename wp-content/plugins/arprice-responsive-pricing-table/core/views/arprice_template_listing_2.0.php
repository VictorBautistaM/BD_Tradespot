...
<input type="hidden" id="arplite_current_date" name="arplite_current_date" value="<?php echo current_time('timestamp'); ?>" />
					...
					<div class="arprice_editable_template_container" id="arp_template_<?php echo esc_attr( $arp_template_id ); ?>">
						...
						?>
							<div class="arprice_template_options_container">    
									<div class="arprice_template_options arprice_template_preview template_action_btn" onClick='arp_price_preview_home("<?php echo $arpricelite_form->get_direct_link( esc_html( $template->ID ), true ); ?>");' title="<?php esc_html_e( 'Preview', 'arprice-responsive-pricing-table' ); ?>" ></div>
									<div class="arprice_template_options arprice_template_edit template_action_btn" title="<?php esc_html_e( 'Select Table', 'arprice-responsive-pricing-table' ); ?>" onclick="window.location.href = '<?php echo admin_url( 'admin.php?page=arpricelite&arp_action=edit&eid=' . esc_html( $template->ID ) ); ?>'"></div>
									<div class="arprice_template_options arprice_template_clone template_action_btn" id="clone_template" data-url="<?php echo admin_url( 'admin.php?page=arpricelite&arp_action=new&eid=' . esc_html( $template->ID ) ); ?>" title="<?php esc_html_e( 'Clone Table', 'arprice-responsive-pricing-table' ); ?>"></div>
			...
			<div class="arprice_select_template_container_item" id="arp_template_<?php echo esc_attr( $template->template_name ); ?>">
				<div class="arprice_select_template_inner_container">
					...
					<div class="arprice_select_template_action_div">
						<div class="arprice_select_template_action_btn arprice_preview_template" id="arprice_preview_template" title="<?php esc_html_e( 'Preview', 'arprice-responsive-pricing-table' ); ?>" onClick='arp_price_preview_home("<?php echo $arpricelite_form->get_direct_link( esc_html( $template->ID ), true ); ?>");'></div>
						<div class="arprice_select_template_action_btn arpice_clone_template" id="clone_template" title="<?php esc_html_e( 'Select', 'arprice-responsive-pricing-table' ); ?>" data-url="<?php echo admin_url( 'admin.php?page=arpricelite&arp_action=new&eid=' . esc_html( $template->ID ) ); ?>"></div>
					</div>
				</div>
			</div>
				<?php
