							...
							<ul class="arp_ribbon_style" data-id="arp_ribbon_style">
								...
								foreach ( $arplite_mainoptionsarr['general_options']['template_options']['arp_ribbons'] as $value => $label ) {
									if ( $value == 'arp_ribbon_6' ) {
										...
										<li class="arp_selectbox_option arp_ribbon_icons" id="arp_ribbon_icons" data-ribbon="<?php echo esc_attr( $value ); ?>" data-label="<?php echo esc_html( $label ); ?>" data-value="<?php echo esc_html( $value ); ?>"><?php echo esc_html( $label ); ?></li>
										<?php
									} else {
										?>
										<li class="arp_selectbox_option arp_ribbon_icons" id="arp_ribbon_icons" data-ribbon="<?php echo esc_attr( $value ); ?>" data-label="<?php echo esc_html( $label ); ?>" data-value="<?php echo esc_html( $value ); ?>"><?php echo esc_html( $label ); ?></li>
...
<div class="arp_pricing_content_skeleton" style="display:none;">
	<div class="col_opt_row" id="price_text">
		...
		<div class="col_opt_input_div width_342">
			...
			<div class="arp_toogle_price_note" id="arp_toogle_price_note" style="<?php echo esc_attr( $arp_style ); ?>"><?php echo sprintf( esc_html__( 'Use class %s for price animation. It will only work with numbers.', 'arprice-responsive-pricing-table' ), '<b>.arp_price_amount</b>' ); ?></div>
